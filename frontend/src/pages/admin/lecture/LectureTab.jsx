...
const MEDIA_API = "http://localhost:8084/api/media";
...
const LectureTab = () => {
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      navigate(`/admin/course/${courseId}/lecture`)   // edit is success then move leture page
    }
    if (error) {
  ...
  useEffect(()=>{
    if(removeSuccess){
      ...
      navigate(`/admin/course/${courseId}/lecture`)   // remove is success then move leture page
    }
  },[removeSuccess])
