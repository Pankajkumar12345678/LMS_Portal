...
const CourseTab = () => {
  ...
  // addtional code for removeCourse start
  const [removeCourseById, { data: removeData, isLoading: removeLoading, isSuccess: removeSuccess }] = useRemoveCourseByIdMutation();
  ...
  // addtional code for removeCourse end
  ...
  const publishStatusHandler = async (action) => {
    try {
      ...
      if (response.data) {
        refetch();
        navigate("/admin/course");   //course is publish then move to courses page
    ...
    <Card>
      <CardHeader className="flex flex-row justify-between">
        ...
        <div className="space-x-2">
          ...
          {/* addtional add Remove course code */}
